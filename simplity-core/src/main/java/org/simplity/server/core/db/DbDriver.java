...
public interface DbDriver {
	 ...
	 * @return the boolean value returned by the reader.
	 * @throws SQLException
	 *
	 */
	 ...
	 * @return the boolean value returned by the updater. false implies that the
	 ...
	 * @return the boolean value returned by the transacter. false implies that the
	 *         transaction was rolled back
