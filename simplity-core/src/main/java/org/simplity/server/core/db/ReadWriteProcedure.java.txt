...
/**
 * Represents a Stored Procedure of an RDBMS that changes data
 *
 ...
 *
 */
public abstract class ReadWriteProcedure extends StoredProcedure {
	 ...
	 * @throws SQLException
	 */
	public StoredProcedureResult qriteIt(IReadWriteHandle handle)
			throws SQLException {
