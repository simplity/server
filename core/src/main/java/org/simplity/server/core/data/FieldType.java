...
public enum FieldType {
	 ...
	 * for insert, and true for other cases. This is handled specifically by the
	 * code
	 */
	GeneratedPrimaryKey {
		@Override
	 ...
	 *         example time-stamp field is not explicitly set in the sql. Also,
	 *         if the primary is generated, then it is not part of the sql
	 *         statement
	 */
	@SuppressWarnings("static-method")
	public boolean isInserted() {
