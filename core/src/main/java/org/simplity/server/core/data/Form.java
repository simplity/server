...
import org.simplity.server.core.service.AbstractService;
...
public abstract class Form<T extends Record> {
	 ...
	 *         not allowed.
	 */
	public Service getService(final IoType operation) {
	...
	protected class AutoService extends AbstractService {
		...
		@Override
		public void serve(final ServiceContext ctx, final InputData inputPayload) throws Exception {
