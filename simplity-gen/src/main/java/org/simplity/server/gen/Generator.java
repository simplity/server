...
public class Generator {
	...
	/**
	 * generate TypeScript record definitions from the given database instance
	 *
	 * @param app    application instance with dbDriver properly set
	 * @param tsRoot root folder where ts files are to be generated. it is assumed
